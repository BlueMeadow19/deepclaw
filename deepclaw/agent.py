...
def create_agent(config, checkpointer):
    ...
    # System prompt from SOUL.md plus runtime context/tool guidance
    base_system_prompt = _load_soul() or ""
    system_prompt = base_system_prompt + _build_runtime_context(config.model)
